...
| **3** ✅ | Backtester: motor barra-a-barra sin look-ahead (decisión en cierre t, ejecución en apertura t+1), comisiones + slippage por lado, sizing/stops por ATR, métricas (retorno, CAGR, Sharpe, Sortino, max drawdown, win rate, profit factor, exposure) | 88 tests verdes · backtest sobre 105k velas 5m + 8.7k velas 1h por símbolo → reportes Markdown/CSV. Hallazgo: la estrategia naïve EMA-cross/RSI pierde en 5m (PF 0.54/0.89) por el peso de los costos; ETHUSDT en 1h roza rentabilidad (PF 1.09, Sharpe 0.57) |
